...
import io
import base64
import sys # Import sys to get traceback info
...
def planarity_api():
    ...
    try:
        ...
        # CRITICAL FIX: Catch all exceptions and return a JSON error
        import traceback
        error_message = f"Internal Python Error. Please check Vercel Logs. Detail: {e}"
        # Print the full traceback to Vercel logs
        print("--- APPLICATION CRASH TRACEBACK ---", file=sys.stderr)
